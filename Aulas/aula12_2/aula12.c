...
void display(void)
{
   ...
   //glBindFramebuffer(GL_FRAMEBUFFER, g_frameBufferId); EU
   glClearColor (0.0, 0.0, 0.0, 0.0);

   //glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); EU
   ...
   //glBindFramebuffer(GL_FRAMEBUFFER, 0); EU
...
void init(int w, int h) 
{
   ...
   //g_frameBufferId = loadFrameBuffer(&g_colorTexId, &g_depthTexId, w, h); EU
}
...
void reshape(int w, int h)
{
   ...
   //glBindFramebuffer(GL_FRAMEBUFFER, g_frameBufferId); EU
   //resizeFrameBuffer(g_colorTexId, g_depthTexId, w, h); EU
   //glBindFramebuffer(GL_FRAMEBUFFER, 0); EU
